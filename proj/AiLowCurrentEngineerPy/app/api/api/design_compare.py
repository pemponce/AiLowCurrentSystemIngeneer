...
async def design_compare(req: dict):
    ...
    from app.db import get_rooms  # Используем get_rooms вместо load_plan_graph
    ...
    return {
        ...
        "method_b": {
            "name": "/design_nn3 (not yet implemented)",
            "status": "TODO: Create /design_nn3 endpoint first"
        },
        "recommendation": (
